  ...
  <div className="container">
    <div className="content">
      ...
      <p> Curabitur accumsan turpis pharetra <strong> augue tincidunt </strong> blandit. Quisque
        ...
        at dignissim dui. Ut et neque nisl. </p>
      <ul>
      ...
      <p> Quisque ante lacus, malesuada ac auctor vitae, congue
        <a> non ante </a>. Phasellus lacus ex, semper ac tortor nec, fringilla
        condimentum orci. Fusce eu rutrum tellus. </p>
      <ol>
      ...
      <p> Phasellus porttitor enim id metus volutpat ultricies. Ut nisi nunc, blandit sed
        ...
        faucibus, mi lacus laoreet metus, at cursus leo est vel tellus. Sed ac posuere est. Nunc
        ultricies nunc neque, vitae ultricies ex sodales quis. Aliquam eu nibh in libero
        accumsan pulvinar. Nullam nec nisl placerat, pretium metus vel, euismod ipsum. Proin
        tempor cursus nisl vel condimentum. Nam pharetra varius metus non pellentesque. </p>
    </div>
  </div>
);
